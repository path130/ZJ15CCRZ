...
typedef struct
{
	...
	unsigned int m_winl;	// display window left
	unsigned int m_wint;	// display window top
	unsigned int m_winw;	// display window width
	unsigned int m_winh;	// display window hight
	unsigned int property;
} Preview_Info;

typedef struct
{
	unsigned int m_dectype;
	unsigned int m_outtype;	// 
	unsigned int m_winl;		// display window left
	unsigned int m_wint;		// display window top
	unsigned int m_winw;		// display window width
...
typedef struct
{
	...
	unsigned int m_encw;	// camera resolution width
	unsigned int m_ench;	// camera resolution hight
	unsigned int property;
	unsigned short  osd_x;		// osd left
	unsigned short  osd_y;		// osd top
	unsigned int m_quality;	// 1~16
	unsigned int m_bcolor;		// when blanc, filled color
	unsigned int m_skiptime;
	unsigned int m_maxkey;
	unsigned int m_scalerinfo;
...
#define IOCTRL_SET_GPIO_VALUE	0x4c434b07
#define IOCTRL_GET_GPIO_VALUE	0x4c434b08
#define IOCTRL_GET_CUSTOM_INFO 0x4c434b09
#ifndef IOCTRL_SET_IRQ_MODE
#define IOCTRL_SET_IRQ_MODE 0x4c434b0b
#endif